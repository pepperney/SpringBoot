...
import com.pepper.boot.learnNetty.HttpJsonServer.codec.HttpJsonRequestEncoder;
import com.pepper.boot.learnNetty.HttpJsonServer.codec.HttpJsonResponseDecoder;
		...
		try {
			...
			b.group(group).channel(NioSocketChannel.class).option(ChannelOption.TCP_NODELAY, true).handler(new ChannelInitializer<SocketChannel>() {
				...
				public void initChannel(SocketChannel ch) throws Exception {
					...
					ch.pipeline().addLast("json-decoder", new HttpJsonResponseDecoder(Order.class));// json解码器
