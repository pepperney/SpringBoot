...
import com.pepper.boot.exception.CustomException;
...
public final class HttpUtil {
	...
	public static Map<String, String> postWithDownload(String reqURL, Map<String, String> params) {
		...
		try {
			...
			if (null != entity
				...
				resultMap.put("failReason", EntityUtils.toString(entity, HttpUtil.DEFAULT_CHARSET));
			}
	...
	public static String httpGet(String url, Map<String, Object> params, String charset) {
		...
		try {
			...
			// 获得HttpGet对象
			HttpGet httpGet = HttpUtil.getHttpGet(url, params, charset);
			// 发送请求获得返回结果
